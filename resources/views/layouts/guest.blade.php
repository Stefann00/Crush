...
<head>
    ...
    <meta name="keywords" content="Male_Fashion, Female_Fashion, creative, fashionm, art, self-made, entepreneuer">
                                ...
                                @if(Route::has('login'))
                                    @auth 
                                        ...
                                        @elseif(Auth::user()->utype=='ENT')
                                            <a title="MyAccount" href="#">{{ Auth::user()->name }} </a>
                                    ...
                                    @else
                                        ...
                                        <a href="{{ route('register') }}">Become a seller</a>
                                    @endif
                                @endif  
