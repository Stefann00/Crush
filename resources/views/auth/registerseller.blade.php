...
<title>CRUSH — Become Seller</title>
...
<div class="signup-form">
    <form action="{{ url('/addseller') }}" method="POST">
        ...
        <div class="form-group">
        	<input type="text" class="form-control input-lg" name="name" placeholder="Full Name" :value="name" autofocus autocomplete="name">
        </div>
		<div class="form-group">
		...
		<div class="form-group">
            <input type="password" class="form-control input-lg" name="password_confirmation" placeholder="Confirm Password" autocomplete="new-password">
        </div>  
        <div class="form-group">
